...
int main()
{
    ...
    try {
        ...
        cout << p1Pointer->getX() << "; " << p1Pointer->getY() << "; " << p1Pointer->getZ() << "; " << p1Pointer->getColor() << endl << endl;
    }
    catch (exception& ex)
    {
        cout << ex.what() << endl;
    ...
    try {
        p1.reset();
        cout << p1Pointer->getX() << "; " << p1Pointer->getY() << "; " << p1Pointer->getZ() << "; " << p1Pointer->getColor() << endl;
    }
    catch (exception& ex)
    {
        cout << ex.what() << endl;
